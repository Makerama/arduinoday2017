...
#define SSID_REDE     "ERON"                //coloque aqui o nome da rede que se deseja conectar
#define SENHA_REDE    "B1C2D3E4F5"          //coloque aqui a senha da rede que se deseja conectar
